              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                  ...
                  <li class="nav-item"><!-- label-->
                      ...
                      <ul class="nav collapse" id="e-commerce">
                          ...
                          <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                  ...
                                  learning</span><span class="badge rounded-pill ms-2 badge-subtle-success">New</span>
                          </div>
                      </a>
                  ...
                  <li class="nav-item"><!-- label-->
                      ...
                      <ul class="nav collapse" id="forms">
                          ...
                          role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="tables">
                          <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                      ...
                      <ul class="nav collapse" id="tables">
                          ...
                          role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="charts">
                          <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                      ...
                                      <ul class="nav collapse" id="item-7">
                                          ...
                                          <li class="nav-item"><a class="nav-link dropdown-indicator"
                                              ...
                                              <ul class="nav collapse" id="item-9">
                                                  <li class="nav-item"><a class="nav-link" href="#!.html">
                                                          <div class="d-flex align-items-center"><span
                                                                  class="nav-link-text ps-1">Item 10</span></div>
                                                      </a><!-- more inner pages--></li>
                                                  <li class="nav-item"><a class="nav-link" href="#!.html">
                                                          <div class="d-flex align-items-center"><span
                                                                  class="nav-link-text ps-1">Item 11</span></div>
                                                      </a><!-- more inner pages--></li>
                                              </ul>
                                          </li>
                                      </ul>
                      ...
                      <ul class="nav collapse" id="customization">
                          ...
                          <li class="nav-item"><a class="nav-link"
                                  ...
                                  <div class="d-flex align-items-center"><span
                                          ...
                                          class="badge rounded-pill ms-2 badge-subtle-success">Updated</span></div>
                              </a><!-- more inner pages--></li>
                          <li class="nav-item"><a class="nav-link"
                      ...
                      <div class="card-body alert mb-0" role="alert">
                          ...
                          <div class="text-center"><img
                              ...
                              <div class="d-grid"><a class="btn btn-sm btn-primary"
                                      href="https://themewagon.com/themes/falcon/" target="_blank">Purchase</a>
                              </div>
                          </div>
                      </div>
                  </div>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-6 col-xxl-3">
                                      <div class="nav flex-column mt-md-4 pt-md-1"><a
                                              ...
                                              href="modules/components/navs-and-tabs/top-navbar.html">Top nav</a>
                                      </div>
                                  </div>
                                  <div class="col-6 col-xxl-3">
                                  ...
                                  <div class="col-6 col-xxl-3">
                                      <div class="nav flex-column">
                                          <p class="nav-link text-700 mb-0 fw-bold">Utilities</p><a
                                              ...
                                              class="nav-link py-1 link-600 fw-medium"
                                              href="modules/utilities/overlayscrollbar.html">Overlay scrollbar</a><a
                                              class="nav-link py-1 link-600 fw-medium"
