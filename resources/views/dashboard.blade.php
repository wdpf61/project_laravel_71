                ...
                <div class="row g-0 h-100 align-items-center">
                    <div class="col">
                        <div class="d-flex align-items-center"><img class="me-3"
                                src="{{ asset('') }}/assets/img/icons/weather-icon.png" alt=""
                                height="60">
                            <div>
    ...
    <div class="col-lg-6 pe-lg-2 mb-3">
        <div class="card h-lg-100 overflow-hidden">
            ...
            <div class="card-footer bg-body-tertiary p-0"><a class="btn btn-sm btn-link d-block w-100 py-2"
                    href="#!">Show all projects<span class="fas fa-chevron-right ms-1 fs-11"></span></a></div>
        </div>
    </div>
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body position-relative">
                ...
                <p class="fs-10 mb-0">Your storage will be running out soon. Get more space and powerful productivity
                    features.</p><a class="btn btn-link fs-10 text-warning mt-lg-3 ps-0" href="#!">Upgrade
    ...
    <div class="col-lg-5 col-xl-4 ps-lg-2 mb-3">
        <div class="card h-100">
            ...
            <div class="card-body pb-0">
                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    ...
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                        ...
                        <div class="hover-actions end-0 top-50 translate-middle-y"><a
                                ...
                                download="download"><img src="{{ asset('') }}/assets/img/icons/cloud-download.svg"
                ...
                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="img-fluid"
                            src="{{ asset('') }}/assets/img/icons/docs.png" alt=""></div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                        <h6 class="mb-1"><a class="stretched-link text-900 fw-semi-bold"
